...
export function IconThreeD(props) {
    return (
        <SvgIcon {...props}
...
export function IconTwoD(props) {
    return (
        <SvgIcon {...props}
...
export function SimpleTwoFloorIcon(props) {
    return (
        <SvgIcon {...props}
...
export function DoubleTwoFloorIcon(props) {
    return (
        <SvgIcon {...props}
